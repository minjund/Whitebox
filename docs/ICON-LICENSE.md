...
- Original project: https://lucide.dev/icons/square-menu
- Pinned source commit: `5d592a96aaeb4a3a09ffd8134f8f5ed878c9a0c5`
...
Retain those notices when redistributing the icon or modified copies. When
distributing the PNG or ICO separately, include the Lucide license as well.

This documents the copyright permission for the source artwork. It is not an
exclusive ownership claim, trademark registration, trademark clearance or a
guarantee against third-party claims. No Dropbox artwork is used.
