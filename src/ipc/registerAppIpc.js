...
function registerAppIpc({ handleTrusted, bootstrap, rendererReady, backgroundState, show, setLocale, setThemeAppearance, setProviderVisibility, setAttentionPopups, setQuestionnairePreference, ackAttentionActivation, syncAttentionPrompts, notifyAttentionPrompt, updateManager, installUpdate }) {
  ...
  handleTrusted('app:set-questionnaire-preference', setQuestionnairePreference);
