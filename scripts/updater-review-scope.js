...
const SENSITIVE_PATH_PATTERNS = Object.freeze([
  ...
  /^package(?:-lock)?\.json$/,
  /^build(?:\/|$)/,
  /^src\/(?:update[^/]*|macUpdateHelper|attentionHookServer|diagnostics)\.js$/,
  /^src\/ipc(?:\/|$)/,
  ...
  /^scripts\/(?:mac-packaged-update-button|mac-update-cohort-check|packaged-update-button|update-restart-regression|electron-asar-cleanup-check)\.js$/,
