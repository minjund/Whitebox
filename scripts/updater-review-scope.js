...
const SENSITIVE_PATH_PATTERNS = Object.freeze([
  ...
  /^scripts\/(?:after-pack|windows-artifact-check|windows-[^/]*update[^/]*|mac-update-integration-test|package-content-check|check-legacy-update-channel|legacy-update-bridge\.config|legacy-update-compatibility|updater-review-scope)\.js$/,
